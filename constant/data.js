...
export const userMenu = [
  { title: "FileGPT", link: "/searchGPT", icon: "bx:chart" },
  { title: "Trend Analysis", link: "/trend-analysis", icon: "mdi:box-outline" },
...
export const adminMenu = [
  ...
  { title: "Users", link: "/admin/manage-users", icon: "mdi:users" },
]
